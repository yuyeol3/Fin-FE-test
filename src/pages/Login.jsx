...
function KakaoButton() {
  ...
  return (
    <button
      ...
      <span className="font-pretendard font-semibold text-[#515151] relative top-px">카카오로 시작하기</span>
    </button>
  )
}
...
function GoogleButton() {
  ...
  return (
    ...
    className="flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-[#51515] py-2.5 rounded-full transition-colors">
      ...
      <span className="font-pretendard font-semibold text-[#515151]  relative top-px">구글로 시작하기</span>
    </button>
  )
}
